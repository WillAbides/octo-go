...
type PullsCreateReqBody struct {
	...
	*/
	...
	/*
	   ...
	   Requests](https://docs.github.com/en/articles/about-pull-requests#draft-pull-requests)"
	...
	*/
	...
	/*
	   **Required with `comfort-fade` preview**. In a split diff view, the side of the
	   ...
	   options](https://docs.github.com/en/articles/about-comparing-branches-in-pull-requests#diff-view-options)".
	*/
	...
	/*
	   **Required when using multi-line comments**. To create multi-line comments, you
	   ...
	   request](https://docs.github.com/en/articles/commenting-on-a-pull-request#adding-line-comments-to-a-pull-request)".
	*/
